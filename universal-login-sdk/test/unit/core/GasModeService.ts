...
describe('UNIT: GasModeService', () => {
  ...
  const getNormalizedCurrencyAmountSpy = sinon.spy((gasModeService as any).getNormalizedCurrencyAmountount);
  (gasModeService as any).getNormalizedCurrencyAmountunt = getNormalizedCurrencyAmountSpy;
